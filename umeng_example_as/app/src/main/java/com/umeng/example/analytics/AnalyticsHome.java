...
public class AnalyticsHome extends Activity {
    ...
    public void onResume() {
        super.onResume();
//        MobclickAgent.onPageStart(mPageName);//可无
//        MobclickAgent.onResume(mContext);//可无
    }

    @Override
    public void onPause() {
        super.onPause();
//        MobclickAgent.onPageEnd(mPageName);//可无
//        MobclickAgent.onPause(mContext);//可无
    }
    ...
    public void onButtonClick(View view) {
        ...
        case R.id.umeng_example_analytics_event_cc:
            ...
            break;
        case R.id.umeng_example_analytics_event://普通事件
            MobclickAgent.onEvent(mContext, "click");
            MobclickAgent.onEvent(mContext, "click", "button");
            break;
        case R.id.umeng_example_analytics_ekv://kv事件
