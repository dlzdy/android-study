	...
	public static Bitmap NV21ToRGBABitmap(byte []nv21, int width, int height, Context context) {
		...
		try {
	    	...
	    	if (mRS == null) {
	    		...
	    		//Type.Builder tb = new Type.Builder(mRS, Element.createPixel(mRS, Element.DataType.UNSIGNED_8, Element.DataKind.PIXEL_LA));
	    		tb.setX(width);
	    		tb.setY(height);
	    		tb.setMipmaps(false);
	    		...
	    		//aOut = Allocation.createTyped(mRS, tb2.create(), Allocation.USAGE_SCRIPT & Allocation.USAGE_GRAPHICS_CONSTANTS);
